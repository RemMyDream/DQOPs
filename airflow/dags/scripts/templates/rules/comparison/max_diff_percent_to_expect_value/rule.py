...
def evaluate_rule(rule_parameters: RuleExecutionRunParameters) -> RuleExecutionResult:
    ...
    if has_actual_value:
        relative_diff = abs(rule_parameters.actual_value - rule_parameters.expected_value)/abs(rule_parameters.expected_value)
        passed = (relative_diff <= rule_parameters.parameters.max_diff_percent/100)
    else:
        passed = False
